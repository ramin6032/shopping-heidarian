...
export const Search = ({ style }) => <Icon component={search} style={style} />;

export const User = ({ style }) => <Icon component={user} style={style} />;

export const Shopping = ({ style }) => (
  <Icon component={shopping} style={style} />
);
