...
import { AmazingOfferSwipperBreakpoints } from "src/lib/consts";
...
const AmazingOfferSlider: React.FC = () => {
  return (
    <>
      <div className="px-3 bg-body rounded">
        <Swiper
          ...
          breakpoints={AmazingOfferSwipperBreakpoints}
        >
          <SwiperSlide>
            <Production
              src={pic4}
...
export default AmazingOfferSlider;
